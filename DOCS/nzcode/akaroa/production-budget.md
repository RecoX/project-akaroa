...
## Notes for Spreadsheet Entry

When entering into the CODE Production Spreadsheet tabs:

1. **Team costs tab** — Enter each role with weekly rate, number of weeks, and whether NZ or overseas
2. **Additional service costs tab** — Enter each service line item with NZ/overseas split
