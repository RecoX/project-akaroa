...
Project Akaroa is a New Zealand-made product designed from the ground up as a digital export. Conreco Limited is an Auckland-based New Zealand company, and all revenue generated by the game returns directly to the New Zealand economy. The KickStart grant enables the hiring of two New Zealand-based roles, Lead Developer and Junior Developer, creating skilled employment in the local games industry. A globally distributed MMO with a large, paying international audience generates export revenue with no physical logistics: precisely the kind of weightless export CODE's mandate is built to support.
...
*The images below are clickable — each links to a YouTube timelapse of the 3D creation process.*
...
Te Reo Māori localisation will be scoped and developed during the production phase, following KickStart completion. Prior to that phase, Conreco Limited will identify and engage an appropriate cultural advisor or iwi partnership to ensure the localisation process is accurate, respectful, and genuinely consultative — not a retrofit.
...
|---|---|---|
| **Phase 1: Core Loop** | Weeks 1–20 | Combat system complete, character progression, basic networking, art pipeline producing final assets |
| **Phase 2: Systems** | Weeks 21–44 | P2P marketplace prototype, faction system, crafting, one complete zone, multiplayer testing |
| **Phase 3: Polish & Validation** | Weeks 45–64 | Sound integration, UI polish, community playtesting via Battle Server model, Steam page live |
| **Phase 4: Vertical Slice** | Weeks 65–72 | Final vertical slice build, documentation for Start Up / publisher pitch, wishlist campaign active |
...
| Trainee / Junior Developer | To be recruited following Lead Developer onboarding | NZ | CODE grant |
...
Lucas Recoaro is the primary technical driver of the project. To mitigate single-person dependency risk, all contractors operate on fixed deliverables with documented specifications, ensuring work can continue or be handed off independently. Core architecture decisions and system designs are documented throughout development as part of standard project practice.
...
**Install instructions:** Uncompress and execute.
